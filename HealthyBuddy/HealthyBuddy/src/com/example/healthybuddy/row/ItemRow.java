...
import com.example.healthybuddy.AppItem;
...
public class ItemRow implements Row
{
	...
	public ItemRow(LayoutInflater inflater, ApplicationInfo app, int id, PackageManager manager)
	{
		mApp = app;
		mID = id;
		mInflater = inflater;
	...
	public View getView(View convertView)
	{
		...
		if (holder.mAppCheckbox.isChecked())
			holder.mAppCheckbox.setChecked(true);
	...
	private static class ViewHolder {
        ...
        final CheckBox mAppCheckbox;

        private ViewHolder(ImageView imageView, TextView titleView, CheckBox checkboxView) {
